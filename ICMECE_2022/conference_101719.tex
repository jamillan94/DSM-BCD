...
\author{\IEEEauthorblockN{1\textsuperscript{st} Jorge Millán}
	\IEEEauthorblockA{\textit{Facultad de ingeniería} \\
		\textit{Universidad Distrital}\\
		Bogotá, Colombia  \\
		jamillang@correo.udistrital.edu.co}
	\and
...
\input{ICMECE/INTRODUCTION}
\input{ICMECE/DEFINITION}
\input{ICMECE/METODOLOGY}
\input{ICMECE/CONCLUSIONS}
