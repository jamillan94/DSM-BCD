...
\begin{table*}[!htb]
	...
	\begin{threeparttable}
		\begin{tabular}{p{2.5cm} p{7cm} p{6.5cm}} \toprule
			...
			%------------------------------------------------------	
			Primary Tumor Site
			& El \textit{sitio del tumor} para identificar la subdivisión de órganos en un individuo con cáncer con base a la décima revisión ICD, se visualiza en orden descendente de la siguiente manera: En primer lugar, 165 pacientes presentan el código \textit{C50.912} el cual corresponde a una neoplasia maligna de sitio no especificado de mama femenina izquierda. En segundo lugar, 160 pacientes presentan el código \textit{C50.412} el cual corresponde a una neoplasia maligna de cuadrante superior externo de mama femenina izquierda. En tercer lugar, 147 pacientes presentan el código \textit{C50.911} el cual corresponde a una neoplasia maligna de sitio no especificado de mama femenina derecha. En cuarto lugar, 145 pacientes presentan el código \textit{C50.411} el cual corresponde a una neoplasia maligna de cuadrante superior externo de mama femenina derecha. En quinto lugar, 50 pacientes presentan el código \textit{C50.212} el cual corresponde a una neoplasia maligna de cuadrante superior interno de mama femenina izquierda. En sexto lugar, 50 pacientes presentan el código \textit{C50.211} el cual corresponde a una neoplasia maligna de cuadrante superior interno de mama femenina derecha. En séptimo lugar, 38 pacientes presentan el código \textit{C50.511} el cual corresponde a una neoplasia maligna de cuadrante inferior externo de mama femenina derecha. En octavo lugar, 32 pacientes presentan el código \textit{C50.512} el cual corresponde a una neoplasia maligna de cuadrante inferior externo de mama femenina izquierda. En noveno lugar, 17 pacientes presentan el código \textit{C50.312} el cual corresponde a una neoplasia maligna de cuadrante inferior interno de mama femenina izquierda. En décimo lugar, 14 pacientes presentan el código \textit{C50.311} el cual corresponde a una neoplasia maligna de cuadrante inferior interno de mama femenina derecha.        
			& \begin{center}\includegraphics[width=1\linewidth]{NOTEBOOK/IMAGENES_DESCRIPTIVAS/25_primary_tumor_site}\end{center}
...
\begin{table*}[!htb]
	...
	\begin{threeparttable}
		\begin{tabular}{p{2.5cm} p{7cm} p{6.5cm}} \toprule
			...
			& El \textit{indicador de colección prospectiva del tejido} se clasifica de forma nominal en dos categorías: La primera categoría corresponde al estado \textit{no} en donde se encuentran 697 en donde la colección de muestras del tejido se adquirió de forma paralela a los  
